### CALCULATION, FORMULATION, AND VISUALIZATION OF 3rd ORDER REACTION
...
# Only run the UI when executed directly
...
r = np.linspace(R_o, 1e-9, 500)  
term_1 = r / R_o
term_2 = 1.0 - term_1

# original formula for t(r)
# Kinetic equation for 3rd order reaction
t = C * (
    (1/(3*k_g)) * (1 - r/R_o)
...
# --- 2D plot (t on x-axis, r on y-axis) ---
