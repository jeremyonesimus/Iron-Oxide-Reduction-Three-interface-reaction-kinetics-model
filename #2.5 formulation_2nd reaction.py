### CALCULATION, FORMULATION, AND VISUALIZATION OF 2nd ORDER REACTION
...
# Kinetic equation for 2nd order reaction
...
def update(val):
    ...
    ax.plot_surface(X, Y, Z, cmap="copper", edgecolor="black", alpha=0.9)
